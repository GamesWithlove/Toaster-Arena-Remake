...
// IWYU pragma: private, include "GetSavedReplaysObject.h"

#ifdef REPLAYSYSTEM_GetSavedReplaysObject_generated_h
#error "GetSavedReplaysObject.generated.h already included, missing '#pragma once' in GetSavedReplaysObject.h"
#endif
#define REPLAYSYSTEM_GetSavedReplaysObject_generated_h
...
private: \
	...
	friend REPLAYSYSTEM_API UClass* ::Z_Construct_UClass_UGetSavedReplaysObject_NoRegister(); \
public: \
	DECLARE_CLASS2(UGetSavedReplaysObject, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/ReplaySystem"), Z_Construct_UClass_UGetSavedReplaysObject_NoRegister) \
...
#define FID_Toaster_Arena_Remake_5_7_Plugins_ReplaySystem_Source_ReplaySystem_Public_GetSavedReplaysObject_h_22_ENHANCED_CONSTRUCTORS \
	...
	UGetSavedReplaysObject(UGetSavedReplaysObject&&) = delete; \
	UGetSavedReplaysObject(const UGetSavedReplaysObject&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UGetSavedReplaysObject); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UGetSavedReplaysObject); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(UGetSavedReplaysObject) \
