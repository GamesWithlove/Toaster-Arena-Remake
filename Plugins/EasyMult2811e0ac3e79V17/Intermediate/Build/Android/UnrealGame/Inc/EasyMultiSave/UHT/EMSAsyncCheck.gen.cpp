...
// ********** Begin Delegate FCheckCompletedPin constinit property declarations ********************
// ********** End Delegate FCheckCompletedPin constinit property declarations **********************
	static const UECodeGen_Private::FDelegateFunctionParams FuncParams;
};
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_EasyMultiSave_CheckCompletedPin__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_EasyMultiSave, nullptr, "CheckCompletedPin__DelegateSignature", 	nullptr, 
	0, 
0,
...
UFunction* Z_Construct_UDelegateFunction_EasyMultiSave_CheckCompletedPin__DelegateSignature()
{
	...
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_EasyMultiSave_CheckCompletedPin__DelegateSignature_Statics::FuncParams);
	}
...
// ********** Begin Delegate FCheckFailedPin constinit property declarations ***********************
// ********** End Delegate FCheckFailedPin constinit property declarations *************************
	static const UECodeGen_Private::FDelegateFunctionParams FuncParams;
};
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_EasyMultiSave_CheckFailedPin__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_EasyMultiSave, nullptr, "CheckFailedPin__DelegateSignature", 	nullptr, 
	0, 
0,
...
UFunction* Z_Construct_UDelegateFunction_EasyMultiSave_CheckFailedPin__DelegateSignature()
{
	...
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_EasyMultiSave_CheckFailedPin__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
...
struct Z_Construct_UDelegateFunction_EasyMultiSave_CheckVersionMismatchPin__DelegateSignature_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Async/Public/EMSAsyncCheck.h" },
...
// ********** Begin Delegate FCheckVersionMismatchPin constinit property declarations **************
// ********** End Delegate FCheckVersionMismatchPin constinit property declarations ****************
	static const UECodeGen_Private::FDelegateFunctionParams FuncParams;
};
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_EasyMultiSave_CheckVersionMismatchPin__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_EasyMultiSave, nullptr, "CheckVersionMismatchPin__DelegateSignature", 	nullptr, 
	0, 
0,
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_EasyMultiSave_CheckVersionMismatchPin__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_EasyMultiSave_CheckVersionMismatchPin__DelegateSignature_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UDelegateFunction_EasyMultiSave_CheckVersionMismatchPin__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_EasyMultiSave_CheckVersionMismatchPin__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FCheckVersionMismatchPin_DelegateWrapper(const FMulticastScriptDelegate& CheckVersionMismatchPin)
{
	CheckVersionMismatchPin.ProcessMulticastDelegate<UObject>(NULL);
}
...
struct Z_Construct_UFunction_UEMSAsyncCheck_CheckSaveFiles_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bComplexCheck_MetaData[] = {
		{ "DisplayName", "Check Version" },
	};
#endif // WITH_METADATA

// ********** Begin Function CheckSaveFiles constinit property declarations ************************
...
// ********** End Function CheckSaveFiles constinit property declarations **************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function CheckSaveFiles Property Definitions ***********************************
...
// ********** End Function CheckSaveFiles Property Definitions *************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UEMSAsyncCheck_CheckSaveFiles_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UEMSAsyncCheck, nullptr, "CheckSaveFiles", 	Z_Construct_UFunction_UEMSAsyncCheck_CheckSaveFiles_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UEMSAsyncCheck_CheckSaveFiles_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_UEMSAsyncCheck_CheckSaveFiles_Statics::EMSAsyncCheck_eventCheckSaveFiles_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEMSAsyncCheck_CheckSaveFiles_Statics::Function_MetaDataParams), Z_Construct_UFunction_UEMSAsyncCheck_CheckSaveFiles_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UEMSAsyncCheck;
UClass* UEMSAsyncCheck::GetPrivateStaticClass()
{
	using TClass = UEMSAsyncCheck;
	if (!Z_Registration_Info_UClass_UEMSAsyncCheck.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("EMSAsyncCheck"),
			Z_Registration_Info_UClass_UEMSAsyncCheck.InnerSingleton,
			StaticRegisterNativesUEMSAsyncCheck,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEMSAsyncCheck.InnerSingleton;
}
UClass* Z_Construct_UClass_UEMSAsyncCheck_NoRegister()
{
	return UEMSAsyncCheck::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UEMSAsyncCheck_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OnCompleted_MetaData[] = {
		{ "Comment", "/* All checked save files are present, loadable and match the required game version. */" },
		{ "DisplayName", "Success" },
		{ "ModuleRelativePath", "Async/Public/EMSAsyncCheck.h" },
		{ "ToolTip", "All checked save files are present, loadable and match the required game version." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OnFailed_MetaData[] = {
		{ "Comment", "/* One or more files are corrupted or failed to deserialize. */" },
		{ "DisplayName", "Invalid Files" },
		{ "ModuleRelativePath", "Async/Public/EMSAsyncCheck.h" },
		{ "ToolTip", "One or more files are corrupted or failed to deserialize." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OnVersionMismatch_MetaData[] = {
		{ "Comment", "/** Files exist and are loadable, but the saved version does NOT match the configured game version (requires 'Check Version' to be true). */" },
		{ "DisplayName", "Version Mismatch" },
		{ "ModuleRelativePath", "Async/Public/EMSAsyncCheck.h" },
		{ "ToolTip", "Files exist and are loadable, but the saved version does NOT match the configured game version (requires 'Check Version' to be true)." },
	};
...
// ********** Begin Class UEMSAsyncCheck constinit property declarations ***************************
	static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnCompleted;
	static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnFailed;
	static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnVersionMismatch;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_EMS;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UEMSAsyncCheck constinit property declarations *****************************
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("CheckSaveFiles"), .Pointer = &UEMSAsyncCheck::execCheckSaveFiles },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UEMSAsyncCheck_CheckSaveFiles, "CheckSaveFiles" }, // 1501363745
	};
...
// ********** Begin Class UEMSAsyncCheck Property Definitions **************************************
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UEMSAsyncCheck_Statics::NewProp_OnCompleted = { "OnCompleted", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEMSAsyncCheck, OnCompleted), Z_Construct_UDelegateFunction_EasyMultiSave_CheckCompletedPin__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnCompleted_MetaData), NewProp_OnCompleted_MetaData) }; // 2075084448
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UEMSAsyncCheck_Statics::NewProp_OnFailed = { "OnFailed", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEMSAsyncCheck, OnFailed), Z_Construct_UDelegateFunction_EasyMultiSave_CheckFailedPin__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnFailed_MetaData), NewProp_OnFailed_MetaData) }; // 1352711377
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UEMSAsyncCheck_Statics::NewProp_OnVersionMismatch = { "OnVersionMismatch", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEMSAsyncCheck, OnVersionMismatch), Z_Construct_UDelegateFunction_EasyMultiSave_CheckVersionMismatchPin__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnVersionMismatch_MetaData), NewProp_OnVersionMismatch_MetaData) }; // 2941648793
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UEMSAsyncCheck_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEMSAsyncCheck_Statics::NewProp_OnVersionMismatch,
...
// ********** End Class UEMSAsyncCheck Property Definitions ****************************************
...
void UEMSAsyncCheck::StaticRegisterNativesUEMSAsyncCheck()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_UEMSAsyncCheck_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UEMSAsyncCheck);
UEMSAsyncCheck::~UEMSAsyncCheck() {}
// ********** End Class UEMSAsyncCheck *************************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Async_Public_EMSAsyncCheck_h__Script_EasyMultiSave_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEMSAsyncCheck, UEMSAsyncCheck::StaticClass, TEXT("UEMSAsyncCheck"), &Z_Registration_Info_UClass_UEMSAsyncCheck, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEMSAsyncCheck), 1280754898U) },
	};
}; // Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Async_Public_EMSAsyncCheck_h__Script_EasyMultiSave_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Async_Public_EMSAsyncCheck_h__Script_EasyMultiSave_1965702818{
	TEXT("/Script/EasyMultiSave"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Async_Public_EMSAsyncCheck_h__Script_EasyMultiSave_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Async_Public_EMSAsyncCheck_h__Script_EasyMultiSave_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
