...
//		FBoneSocketTarget LookAtTarget;
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = InputData, meta = (DisplayName = "Hands Input Info", PinHiddenByDefault))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = InputData, meta = (DisplayName = "Target Transform", PinShownByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (DisplayName = "(optional) Extra Offset on the elbow poles", PinHiddenByDefault))
		FVector Extra_Elbow_Pole_Offset = FVector(0,0,0);
...
//		bool Work_Outside_PIE = true;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (DisplayName = "Should arm stretch ?", PinHiddenByDefault))
	bool allow_arm_stretch = false;
