...
#include "WaterLibraryBP.generated.h"
...
*/
UCLASS()
class UWaterLibraryBP : public UBlueprintFunctionLibrary
{
	GENERATED_UCLASS_BODY()
	
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", Keywords = "WaterLibrary water waves"), Category = "WaterLibrary")
	...
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", Category = "WaterLibrary"))
