...
void FOnPakFileMounted2_DelegateWrapper(const FMulticastScriptDelegate& OnPakFileMounted2, const FString& PakFilename, const FString& MountPoint, int32 NumFiles)
{
	...
	UPakLoaderSubsystem::~UPakLoaderSubsystem() {}
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PakLoader_Source_PakLoader_Public_PakLoaderSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PakLoader_Source_PakLoader_Public_PakLoaderSubsystem_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PakLoader_Source_PakLoader_Public_PakLoaderSubsystem_h_2343846673(TEXT("/Script/PakLoader"),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PakLoader_Source_PakLoader_Public_PakLoaderSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PakLoader_Source_PakLoader_Public_PakLoaderSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
