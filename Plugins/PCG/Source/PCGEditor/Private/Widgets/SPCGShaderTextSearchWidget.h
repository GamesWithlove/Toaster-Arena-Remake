...
/** Search text field. */
class SPCGShaderTextSearchWidget : public SCompoundWidget
{
public:
	SPCGShaderTextSearchWidget();
	~SPCGShaderTextSearchWidget() override;

	SLATE_BEGIN_ARGS(SPCGShaderTextSearchWidget) {};
