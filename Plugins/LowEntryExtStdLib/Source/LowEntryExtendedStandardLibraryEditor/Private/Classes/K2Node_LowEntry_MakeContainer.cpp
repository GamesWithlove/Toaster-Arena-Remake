...
void FKCHandler_LowEntry_MakeContainer::RegisterNets(FKismetFunctionContext& Context, UEdGraphNode* Node)
{
	UK2Node_LowEntry_MakeContainer* ContainerNode = CastChecked<UK2Node_LowEntry_MakeContainer>(Node);
...
void FKCHandler_LowEntry_MakeContainer::Compile(FKismetFunctionContext& Context, UEdGraphNode* Node)
{
	UK2Node_LowEntry_MakeContainer* ContainerNode = CastChecked<UK2Node_LowEntry_MakeContainer>(Node);
	UEdGraphPin* OutputPin = ContainerNode->GetOutputPin();
...
/////////////////////////////////////////////////////
// UK2Node_LowEntry_MakeContainer
...
UEdGraphPin* UK2Node_LowEntry_MakeContainer::GetOutputPin() const
{
	return FindPin(GetOutputPinName());
}

void UK2Node_LowEntry_MakeContainer::ReallocatePinsDuringReconstruction(TArray<UEdGraphPin*>& OldPins)
{
...
bool UK2Node_LowEntry_MakeContainer::CanResetToWildcard() const
{
...
void UK2Node_LowEntry_MakeContainer::NotifyPinConnectionListChanged(UEdGraphPin* Pin)
{
...
void UK2Node_LowEntry_MakeContainer::PropagatePinType()
{
...
void UK2Node_LowEntry_MakeContainer::PostReconstructNode()
{
...
void UK2Node_LowEntry_MakeContainer::InteractiveAddInputPin()
{
	FScopedTransaction Transaction(LOCTEXT("AddPinTx", "Add Pin"));
	AddInputPin();
}

void UK2Node_LowEntry_MakeContainer::AddInputPin()
{
	Modify();
...
FName UK2Node_LowEntry_MakeContainer::GetPinName(const int32 PinIndex) const
{
...
void UK2Node_LowEntry_MakeContainer::RemoveInputPin(UEdGraphPin* Pin)
{
...
void UK2Node_LowEntry_MakeContainer::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
