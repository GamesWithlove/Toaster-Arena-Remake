...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_SteamCore_OnUserStatsReceived__DelegateSignature_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_SteamCore_eventOnUserStatsReceived_Parms, Data), Z_Construct_UScriptStruct_FUserStatsReceived, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Data_MetaData), NewProp_Data_MetaData) }; // 3757884125
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_SteamCore_OnRequestUserStats__DelegateSignature_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_SteamCore_eventOnRequestUserStats_Parms, Data), Z_Construct_UScriptStruct_FRequestUserStatsData, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Data_MetaData), NewProp_Data_MetaData) }; // 808212394
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCore_Source_SteamCore_Public_SteamUserStats_SteamUserStatsTypes_h__Script_SteamCore_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESteamLeaderboardDataRequest_StaticEnum, TEXT("ESteamLeaderboardDataRequest"), &Z_Registration_Info_UEnum_ESteamLeaderboardDataRequest, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4290380942U) },
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSteamLeaderboardEntries::StaticStruct, Z_Construct_UScriptStruct_FSteamLeaderboardEntries_Statics::NewStructOps, TEXT("SteamLeaderboardEntries"),&Z_Registration_Info_UScriptStruct_FSteamLeaderboardEntries, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSteamLeaderboardEntries), 1854366441U) },
		{ FSteamLeaderboardEntry::StaticStruct, Z_Construct_UScriptStruct_FSteamLeaderboardEntry_Statics::NewStructOps, TEXT("SteamLeaderboardEntry"),&Z_Registration_Info_UScriptStruct_FSteamLeaderboardEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSteamLeaderboardEntry), 1108240009U) },
		...
		{ FUserStatsReceived::StaticStruct, Z_Construct_UScriptStruct_FUserStatsReceived_Statics::NewStructOps, TEXT("UserStatsReceived"),&Z_Registration_Info_UScriptStruct_FUserStatsReceived, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUserStatsReceived), 3757884125U) },
		...
		{ FUserStatsUnloaded::StaticStruct, Z_Construct_UScriptStruct_FUserStatsUnloaded_Statics::NewStructOps, TEXT("UserStatsUnloaded"),&Z_Registration_Info_UScriptStruct_FUserStatsUnloaded, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUserStatsUnloaded), 3197885834U) },
		{ FLeaderboardScoresDownloaded::StaticStruct, Z_Construct_UScriptStruct_FLeaderboardScoresDownloaded_Statics::NewStructOps, TEXT("LeaderboardScoresDownloaded"),&Z_Registration_Info_UScriptStruct_FLeaderboardScoresDownloaded, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLeaderboardScoresDownloaded), 2074583049U) },
		{ FLeaderboardScoresDownloadedForUsers::StaticStruct, Z_Construct_UScriptStruct_FLeaderboardScoresDownloadedForUsers_Statics::NewStructOps, TEXT("LeaderboardScoresDownloadedForUsers"),&Z_Registration_Info_UScriptStruct_FLeaderboardScoresDownloadedForUsers, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLeaderboardScoresDownloadedForUsers), 4093151137U) },
		{ FRequestUserStatsData::StaticStruct, Z_Construct_UScriptStruct_FRequestUserStatsData_Statics::NewStructOps, TEXT("RequestUserStatsData"),&Z_Registration_Info_UScriptStruct_FRequestUserStatsData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRequestUserStatsData), 808212394U) },
...
}; // Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCore_Source_SteamCore_Public_SteamUserStats_SteamUserStatsTypes_h__Script_SteamCore_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCore_Source_SteamCore_Public_SteamUserStats_SteamUserStatsTypes_h__Script_SteamCore_3475830077{
	TEXT("/Script/SteamCore"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCore_Source_SteamCore_Public_SteamUserStats_SteamUserStatsTypes_h__Script_SteamCore_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCore_Source_SteamCore_Public_SteamUserStats_SteamUserStatsTypes_h__Script_SteamCore_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCore_Source_SteamCore_Public_SteamUserStats_SteamUserStatsTypes_h__Script_SteamCore_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCore_Source_SteamCore_Public_SteamUserStats_SteamUserStatsTypes_h__Script_SteamCore_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
