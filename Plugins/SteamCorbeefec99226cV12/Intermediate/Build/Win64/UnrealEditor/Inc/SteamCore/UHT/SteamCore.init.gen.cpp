...
static_assert(!UE_WITH_CONSTINIT_UOBJECT, "This generated code can only be compiled with !UE_WITH_CONSTINIT_OBJECT");	STEAMCORE_API UFunction* Z_Construct_UDelegateFunction_SteamCore_EndGameResultDelegate__DelegateSignature();
	...
	static FPackageRegistrationInfo Z_Registration_Info_UPackage__Script_SteamCore;
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_SteamCore()
	{
		if (!Z_Registration_Info_UPackage__Script_SteamCore.OuterSingleton)
		{
		static UObject* (*const SingletonFuncArray[])() = {
			...
			(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnControllerChangedCallback__DelegateSignature,
			...
			(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetTicketForWebApiResponse__DelegateSignature,
			...
			(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnNewUrlLaunchParametersDelegate__DelegateSignature,
			...
			(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnTimedTrialStatusDelegate__DelegateSignature,
			...
			(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUserSubscribedItemsListChanged__DelegateSignature,
		...
		UECodeGen_Private::ConstructUPackage(Z_Registration_Info_UPackage__Script_SteamCore.OuterSingleton, PackageParams);
	}
	return Z_Registration_Info_UPackage__Script_SteamCore.OuterSingleton;
}
static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_SteamCore(Z_Construct_UPackage__Script_SteamCore, TEXT("/Script/SteamCore"), Z_Registration_Info_UPackage__Script_SteamCore, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x1693CA48, 0x20912B40));
