...
private:
	...
	STEAM_CALLBACK_MANUAL(UApps, OnNewUrlLaunchParameters, NewUrlLaunchParameters_t, OnNewUrlLaunchParametersCallback);
#if STEAM_VERSION > 147
	STEAM_CALLBACK_MANUAL(UApps, OnTimedTrialStatus, TimedTrialStatus_t, OnTimedTrialStatusCallback);
#endif
#endif
};
