...
public:
	...
	/**
	 * Workaround for Multiplayer Sessions in Unreal Engine 5.5
	 */
	
	UFUNCTION(BlueprintCallable, Category = "SteamCore|Utilities", meta = (Uparam))
	static void PatchSessionResult(UPARAM(ref) const FBlueprintSessionResult& SearchResult, FBlueprintSessionResult& SessionResult);
