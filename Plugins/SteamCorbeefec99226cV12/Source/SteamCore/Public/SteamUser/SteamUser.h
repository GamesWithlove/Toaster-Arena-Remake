...
public:
	...
	// This Callback is only available in UE 5.4+
	UPROPERTY(BlueprintAssignable, Category = "SteamCore|User|Delegates")
...
private:
	...
	STEAM_CALLBACK_MANUAL(UUser, OnGetTicketForWebApiResponse, GetTicketForWebApiResponse_t, OnGetTicketForWebApiResponseCallback);
#endif
#endif
};