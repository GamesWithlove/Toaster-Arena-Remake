...
public:
	...
	*/
	...
	static USteamCoreWebAsyncActionAddItem* AddItemAsync(UObject* WorldContextObject, FString Key, int32 AppId, TArray<int32> ItemdefId, FString ItemPropsJson, TArray<int32> ItemQuantity, FString SteamId, bool bNotify, FString RequestId, bool bTradeRestriction);
};
...
public:
	...
	*/
	...
	static USteamCoreWebAsyncActionExchangeItem* ExchangeItemAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString SteamId, TArray<int64> MaterialsItemId, TArray<int32> MaterialsQuantity, int64 OutputItemdefId);
};
...
public:
	...
	*/
	...
	static USteamCoreWebAsyncActionModifyItems* ModifyItemsAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString SteamId, FModifyItemsItem Updates);
};
