...
{
public:
	FOnlineAsyncTaskSteamCoreWebAddItem(USteamCoreWebSubsystem* subsystem, const FOnSteamCoreWebCallback& Callback, FString Key, int32 AppId, TArray<int32> ItemdefId, FString ItemPropsJson, TArray<int32> ItemQuantity, FString SteamId, bool bNotify, FString RequestId, bool bTradeRestriction)
...
{
public:
	FOnlineAsyncTaskSteamCoreWebExchangeItem(USteamCoreWebSubsystem* subsystem, const FOnSteamCoreWebCallback& Callback, FString Key, int32 AppId, FString SteamId, TArray<int64> MaterialsItemID, TArray<int32> MaterialsQuantity, int64 OutputItemdefId)
...
{
public:
	FOnlineAsyncTaskSteamCoreWebModifyItems(USteamCoreWebSubsystem* subsystem, const FOnSteamCoreWebCallback& Callback, FString Key, int32 AppId, FString SteamId, FModifyItemsItem Updates)
