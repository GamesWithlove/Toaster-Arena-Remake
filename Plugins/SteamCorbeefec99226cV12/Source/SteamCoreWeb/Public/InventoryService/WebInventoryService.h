...
public:
	...
	*/
	...
	void AddItem(const FOnSteamCoreWebCallback& Callback, FString Key, int32 AppId, TArray<int32> ItemdefId, FString ItemPropsJson, TArray<int32> ItemQuantity, FString SteamId, bool bNotify, FString RequestId, bool bTradeRestriction);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SteamCoreWeb|InventoryService")
	void ExchangeItem(const FOnSteamCoreWebCallback& Callback, FString Key, int32 AppId, FString SteamId, TArray<int64> MaterialsItemID, TArray<int32> MaterialsQuantity, int64 OutputItemdefId);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SteamCoreWeb|InventoryService")
	void ModifyItems(const FOnSteamCoreWebCallback& Callback, FString Key, int32 AppId, FString SteamId, FModifyItemsItem Updates);
};
