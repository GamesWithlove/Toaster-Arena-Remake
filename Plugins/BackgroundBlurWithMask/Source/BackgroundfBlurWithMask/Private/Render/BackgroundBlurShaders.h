...
public:
	...
	{
		SetShaderValue(RHICmdList, RHICmdList.GetBoundPixelShader(), SourceUVBounds, InSourceUVBounds);
	}
	...
	{
		SetShaderValue(RHICmdList, RHICmdList.GetBoundPixelShader(), MaskTransformParameter, InMaskTransform);
	}
