...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VaRest_Source_VaRest_Public_VaRestTypes_h__Script_VaRest_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EVaRestRequestVerb_StaticEnum, TEXT("EVaRestRequestVerb"), &Z_Registration_Info_UEnum_EVaRestRequestVerb, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2395183863U) },
		{ EVaRestRequestContentType_StaticEnum, TEXT("EVaRestRequestContentType"), &Z_Registration_Info_UEnum_EVaRestRequestContentType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2185392776U) },
		{ EVaRestRequestStatus_StaticEnum, TEXT("EVaRestRequestStatus"), &Z_Registration_Info_UEnum_EVaRestRequestStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 730143780U) },
		{ EVaRestHttpStatusCode_StaticEnum, TEXT("EVaRestHttpStatusCode"), &Z_Registration_Info_UEnum_EVaRestHttpStatusCode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2826649919U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FVaRestURL::StaticStruct, Z_Construct_UScriptStruct_FVaRestURL_Statics::NewStructOps, TEXT("VaRestURL"),&Z_Registration_Info_UScriptStruct_FVaRestURL, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVaRestURL), 4030536348U) },
	};
}; // Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VaRest_Source_VaRest_Public_VaRestTypes_h__Script_VaRest_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VaRest_Source_VaRest_Public_VaRestTypes_h__Script_VaRest_384977193{
	TEXT("/Script/VaRest"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VaRest_Source_VaRest_Public_VaRestTypes_h__Script_VaRest_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VaRest_Source_VaRest_Public_VaRestTypes_h__Script_VaRest_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VaRest_Source_VaRest_Public_VaRestTypes_h__Script_VaRest_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VaRest_Source_VaRest_Public_VaRestTypes_h__Script_VaRest_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
