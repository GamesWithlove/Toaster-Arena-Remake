...
public:
	...
	void CleanupLocal(bool bRemoveComponents, bool bSave, const TArray<FPCGTaskId>& Dependencies);
	...
	void CleanupLocalDeleteAllGeneratedObjects(const TArray<FPCGTaskId>& Dependencies);
	...
	*/
	...
	FPCGGridDescriptor GetGridDescriptor(uint32 GridSize) const;
...
protected:
	...
	static void PurgeUnlinkedResources(const AActor* InActor);
...
private:
	...
	void UpdateRuntimeGridDescriptorHash();
#endif
